...
export * from './lib/vet-main-view/vet-main-view.component'
...
export * from './lib/vet-service-clinic-view/vet-service-clinic-view.component'
...
export * from './lib/vet-pets-view/vet-pets-view.component'
export * from './lib/vet-opening-hour-view/vet-opening-hour-view.component'
export * from './lib/vet-employment-view/vet-employment-view.component'
export * from './lib/clients-view/clients-view.component'
